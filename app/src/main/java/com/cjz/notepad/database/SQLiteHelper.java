package com.cjz.notepad.database;
    ...
    public List<NotepadBean> query(){
        ...
        if (cursor!=null){
            while (cursor.moveToNext()){
                ...
                noteInfo.setId(cursor.getString(cursor.getColumnIndex(DBUtils.NOTEPAD_ID)));
                noteInfo.setNotepadContent(cursor.getString(cursor.getColumnIndex(DBUtils.NOTEPAD_CONTENT)));
                noteInfo.setNotepadTime(cursor.getString(cursor.getColumnIndex(DBUtils.NOTEPAD_TIME)));
                list.add(noteInfo);
            }
            cursor.close();
        }
